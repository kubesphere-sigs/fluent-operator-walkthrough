...
helm upgrade --install fluent-operator --create-namespace -n "$LOGGING_NAMESPACE" --wait --timeout 10m https://github.com/fluent/fluent-operator/releases/download/v1.0.1/fluent-operator.tgz
